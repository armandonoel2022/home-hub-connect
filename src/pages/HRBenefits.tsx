...
const DEFAULT_BENEFITS_SEED: Benefit[] = [
  {
    id: "BNF-001",
  ...
  },
  {
    ...
    details: [
      ...
      "El colaborador debe enviar un correo a Recursos Humanos con copia a su supervisor indicando día y horas que estará consumiendo.",
    ],
    order: 3,
  },
  {
    ...
    color: "emerald",
    appliesTo: "Todos los colaboradores",
    summary: "La empresa cubre el 100% del costo del plan médico del colaborador.",
    details: [
      "Plan Staff: para personal de Staff.",
      "Plan Gerencial: para Gerentes en adelante.",
      "Dependientes adicionales (hijos mayores de 25 años, padres, suegros, etc.): el colaborador asume el 100% del costo.",
      "Cambio de plan permitido en cualquier momento; la diferencia se descuenta vía nómina.",
      "Hijastros requieren autorización expresa del Gerente General. Hijos adoptados requieren poder judicial firmado por el progenitor y abogado.",
      "No se aceptan ex esposos ni parejas en unión libre disuelta en la póliza; el colaborador debe informar el cambio de estatus y solicitar la exclusión, de lo contrario el costo se descuenta vía nómina.",
      "Es responsabilidad del colaborador enviar el acta de nacimiento de hijos recién nacidos para tramitar el ingreso oportuno al seguro.",
    ],
    order: 4,
  },
  {
    ...
    details: [
      "Días libres adicionales como 24 de Diciembre, 31 de Diciembre, Jueves Santo, entre otros.",
  ...
  },
  {
    ...
    details: [
      ...
      "Aprobados por el supervisor del área y la gerencia general.",
    ],
    order: 7,
  },
];
